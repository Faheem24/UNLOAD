  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">UNLOAD Detection Features</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
          ...
          <div class="col-lg-6">
            <div class="card card-primary card-outline">
              <div class="card-body">
                ...
                <p class="card-text">
                  Detection of Guessing of Password by Brute Force Method, meaning malicious user is trying to login.
                </p>

                <a href="Log2.aspx" class="card-link">See Logs</a>
                <a href="Alert2.aspx" class="card-link">See Alerts</a>
              </div>
            </div>
              ...
              <div class="card-body">
                ...
                <p class="card-text">
                  Login of a User Account whose owner is out of Office, meaning malicious user has logged on.
                </p>
                <a href="Log2.aspx" class="card-link">See Logs</a>
                <a href="Alert2.aspx" class="card-link">See Alerts</a>
              </div>
            ...
            <div class="card card-primary card-outline">
              <div class="card-body">
                <h5 class="card-title">2. Outside Remote Login</h5>

                <p class="card-text">
                  Login on the system remotely (RDP) from a system which is not allowed, meaning malicious system has logged on.
                </p>
                <a href="Log2.aspx" class="card-link">See Logs</a>
                <a href="Alert2.aspx" class="card-link">See Alerts</a>
              </div>
