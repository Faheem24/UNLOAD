<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Alert2.aspx.cs" Inherits="UNLOAD_Web_UI.Alert2" %>
...
<head runat="server">
  ...
  <title>UNLOAD | Alerts</title>
    ...
    <script>
        $(function () {
            $("#AlertGridView").prepend($("<thead></thead>").append($(this).find("tr:first"))).dataTable();
        });
    </script>
...
<body class="hold-transition sidebar-mini">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="Alert2.aspx" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Alerts</p>
                </a>
              </li>
  ...
  <div class="content-wrapper">
    ...
    <!-- Main content -->
    <div class="content">
      <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:UNLOADDBConnectionString %>" SelectCommand="SELECT * FROM [Alert] ORDER BY [AlertID] DESC"></asp:SqlDataSource>
            <asp:GridView ID="AlertGridView" runat="server" AutoGenerateColumns="False" DataKeyNames="AlertID" DataSourceID="SqlDataSource1">
                <Columns>
                    ...
                    <asp:BoundField DataField="AlertDetail" HeaderText="Alert Detail" SortExpression="AlertDetail" />
                </Columns>
            </asp:GridView>
    </div>
    <!-- /.content -->
